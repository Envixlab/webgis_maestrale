var size = 0;
var categories_DistribuzionepotenzialedelMolossodiCestoni = {"Alta": [ new ol.style.Style({
...
var styleCache_DistribuzionepotenzialedelMolossodiCestoni={}
var style_DistribuzionepotenzialedelMolossodiCestoni = function(feature, resolution){
    var value = feature.get("Probabilità di presenza");
    var style = categories_DistribuzionepotenzialedelMolossodiCestoni[value];
    if ("" !== null) {
    ...
    if (!styleCache_DistribuzionepotenzialedelMolossodiCestoni[key]){
        ...
        styleCache_DistribuzionepotenzialedelMolossodiCestoni[key] = new ol.style.Style({"text": text})
    }
    var allStyles = [styleCache_DistribuzionepotenzialedelMolossodiCestoni[key]];
