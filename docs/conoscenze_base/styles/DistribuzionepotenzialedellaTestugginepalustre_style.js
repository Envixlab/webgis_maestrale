var size = 0;
var categories_DistribuzionepotenzialedellaTestugginepalustre = {"Alta": [ new ol.style.Style({
...
var styleCache_DistribuzionepotenzialedellaTestugginepalustre={}
var style_DistribuzionepotenzialedellaTestugginepalustre = function(feature, resolution){
    var value = feature.get("Probabilità di presenza");
    var style = categories_DistribuzionepotenzialedellaTestugginepalustre[value];
    if ("" !== null) {
    ...
    if (!styleCache_DistribuzionepotenzialedellaTestugginepalustre[key]){
        ...
        styleCache_DistribuzionepotenzialedellaTestugginepalustre[key] = new ol.style.Style({"text": text})
    }
    var allStyles = [styleCache_DistribuzionepotenzialedellaTestugginepalustre[key]];
