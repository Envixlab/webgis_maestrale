var size = 0;
var categories_DistribuzionepotenzialedellaNottolacomune = {"Alta": [ new ol.style.Style({
...
var styleCache_DistribuzionepotenzialedellaNottolacomune={}
var style_DistribuzionepotenzialedellaNottolacomune = function(feature, resolution){
    var value = feature.get("Probabilità di presenza");
    var style = categories_DistribuzionepotenzialedellaNottolacomune[value];
    if ("" !== null) {
    ...
    if (!styleCache_DistribuzionepotenzialedellaNottolacomune[key]){
        ...
        styleCache_DistribuzionepotenzialedellaNottolacomune[key] = new ol.style.Style({"text": text})
    }
    var allStyles = [styleCache_DistribuzionepotenzialedellaNottolacomune[key]];
