var size = 0;
var categories_DistribuzionepotenzialedelPipistrellodiSavi = {"Alta": [ new ol.style.Style({
...
var styleCache_DistribuzionepotenzialedelPipistrellodiSavi={}
var style_DistribuzionepotenzialedelPipistrellodiSavi = function(feature, resolution){
    var value = feature.get("Probabilità di presenza");
    var style = categories_DistribuzionepotenzialedelPipistrellodiSavi[value];
    if ("" !== null) {
    ...
    if (!styleCache_DistribuzionepotenzialedelPipistrellodiSavi[key]){
        ...
        styleCache_DistribuzionepotenzialedelPipistrellodiSavi[key] = new ol.style.Style({"text": text})
    }
    var allStyles = [styleCache_DistribuzionepotenzialedelPipistrellodiSavi[key]];
