...
var map = new ol.Map({
    controls: ol.control.defaults({attribution:false}).extend([
        expandedAttribution,new ol.control.ScaleLine({}),new ol.control.LayerSwitcher({tipLabel: "Layers"}),new measureControl(), new ol.control.FullScreen()
    ]),
...
map.getView().fit([1634282.854581, 5139220.015518, 1706690.833332, 5177423.844307], map.getSize());
